...
from llm_tools_5.utils import create_dataset, tokenize_texts, tokenize_docs, tokenize_texts_and_labels, get_training_args
...
class MyTrainer:
    ...
    def __init__(self, model_name, x_train, x_test, y_train=None, y_test=None, training_args=None,
                 context_length=None,
                 model_output_dir=None, type="text"):
        ...
        # self.tokenized_datasets = self.tokenized_datasets.add_column("labels", self.tokenized_datasets["input_ids"])
